...
-- vim.keymap.set("n", "<C-H>", "<C-w> < <CR>", { desc = "Resize window to left" })
-- vim.keymap.set("n", "<C-L>", "<C-w> > <CR>", { desc = "Resize window to right" })
-- vim.keymap.set("n", "<C-J>", "<C-w> + <CR>", { desc = "Resize window to up" })
-- vim.keymap.set("n", "<C-K>", "<C-w> - <CR>", { desc = "Resize window to down" })
-- Custom Keymaps WIP
...
require("lazy").setup({
...

	{
		...
		config = function()
			-- Optional: configure vim-devicons here if needed
		end,
	},
	...
	--  config = function() ... end
	--  {
	-- 42 Header and Norminette Plugins
	--[[ {
