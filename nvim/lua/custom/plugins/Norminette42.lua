...
-- 			-- Handle each line of output (not needed in this specific case)
-- 		end,
--
...
-- 			else
-- 				vim.schedule(function()
-- 					vim.api.nvim_err_writeln("Norminette failed with exit code " .. return_val)
-- 				end)
-- 			end
-- 		end,
--
...
-- 			vim.schedule(function()
-- 				if data then
-- 					vim.api.nvim_err_writeln("Norminette error: " .. data)
-- 				end
-- 			end)
-- 		end,
-- 	}):start()
