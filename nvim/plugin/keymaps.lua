...
-- vim.keymap.set("n", "<C-k>", "<C-w><C-k>", { desc = "Move focus to the upper window" })  vim.keymap.set("n", "j", "gj", { desc = "Move Down", silent = true }) vim.keymap.set("n", "j", "gj", { desc = "Move Down", silent = true }) vim.keymap.set("n", "j", "gj", { desc = "Move Down", silent = true }) vim.keymap.set("n", "j", "gj", { desc = "Move Down", silent = true }) vim.keymap.set("n", "j", "gj", { desc = "Move Down", silent = true })vim.keymap.set("n", "j", "gj", { desc = "Move Down", silent = true })
