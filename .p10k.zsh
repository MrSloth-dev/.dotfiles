# Generated by Powerlevel10k configuration wizard on 2025-01-18 at 01:35 WET.
...
##################################[ dir: current directory ]##################################
# Current directory background color (Gruvbox blue).
typeset -g POWERLEVEL9K_DIR_BACKGROUND=24  # Hex: #83a598
# Default current directory foreground color (Gruvbox light foreground).
typeset -g POWERLEVEL9K_DIR_FOREGROUND=223  # Hex: #ebdbb2
# If directory is too long, shorten some of its segments to the shortest possible unique
# prefix. The shortened directory can be tab-completed to the original.
typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique
# Replace removed segment suffixes with this symbol.
typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=
# Color of the shortened directory segments (Gruvbox gray).
typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=245  # Hex: #928374
# Color of the anchor directory segments (Gruvbox aqua).
typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=108  # Hex: #8ec07c
...
# Clean state background color (Gruvbox green).
typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=106  # Hex: #b8bb26
# Modified state background color (Gruvbox yellow).
typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=214  # Hex: #fabd2f
# Untracked state background color (Gruvbox green).
typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=106  # Hex: #b8bb26
# Conflicted state background color (Gruvbox red).
typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=167  # Hex: #fb4934
# Loading state background color (Gruvbox gray).
typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=245  # Hex: #928374
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#282828'
  ...
  #######################[ background_jobs: presence of background jobs ]#######################
  # Background jobs color. typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#ebdbb2'
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND='#282828'
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color (Gruvbox light foreground on dark background).
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=223  # Hex: #ebdbb2
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND=235  # Hex: #282828
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_BACKGROUND='#83a598'
